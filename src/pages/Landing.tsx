    ...
    <div className="space-y-24">
      ...
      <section className="relative overflow-hidden rounded-2xl border bg-card/60 py-16 md:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <div className="mx-auto mb-6 inline-flex items-center justify-center rounded-xl border bg-background/70 px-4 py-2 shadow-sm backdrop-blur animate-fade-in">
            <AppStoreLogo />
          </div>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground md:text-xl animate-fade-in-up" style={{ animationDelay: '120ms' }}>
            {t("heroSubtitle")}
          </p>
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3 animate-fade-in-up" style={{ animationDelay: '220ms' }}>
            ...
            <Button variant="outline" asChild>
              <a href="https://github.com/kagantemizkan" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1">
                GitHub Profile
      ...
      <section className="text-center space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
          <div className="space-y-2 rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-shadow animate-fade-in-up" style={{ animationDelay: '50ms' }}>
            <div className="text-4xl font-bold text-primary">
              {<AnimatedCounter to={portfolioStats.totalApps} />}
            </div>
            <div className="text-muted-foreground font-medium">Apps Built</div>
          </div>
          <div className="space-y-2 rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-shadow animate-fade-in-up" style={{ animationDelay: '120ms' }}>
            <div className="text-4xl font-bold text-primary">
          ...
          <div className="space-y-2 rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-shadow animate-fade-in-up" style={{ animationDelay: '190ms' }}>
            <div className="text-4xl font-bold text-primary">
          ...
          <div className="space-y-2 rounded-xl border bg-card p-6 shadow-sm hover:shadow-md transition-shadow animate-fade-in-up" style={{ animationDelay: '260ms' }}>
            <div className="text-4xl font-bold text-primary">
              {<AnimatedCounter to={portfolioStats.technologies.length} />}
            </div>
